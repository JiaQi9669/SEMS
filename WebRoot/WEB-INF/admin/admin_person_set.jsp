			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="viewadd" class="btn btn-sm btn-success">
							...
							<div class="col-xs-12">
								<div class="widget-box">
									<div class="widget-header">
										<h4 class="smaller bolder">人员名单</h4>
									</div>
												...
												<div class="table-margin">
							                      ...
							                      <thead>
							                         ...
							                         <tr>
							                          ...
							                          <td>${name }</td>
							                          <td>
							                          	<s:if test="%{role == 1 }">管理员</s:if>
							                          	<s:else>普通</s:else>
							                          </td>
							                          <td>
							                          	<s:if test="%{role == 1 }"></s:if>
							                          	<s:else>
							                          		<a href="admindelete?id=${id }" onclick="return confirm('确定删除改人员吗？');" class="btn btn-default btn-sm">
															...
															<td colspan="7">
																<div class="pull-right">
								                                  <nav>
								                                      <ul class="pagination">
								                                      <li>
								                                          <a href="adminperson?pageNum=0" aria-label="Previous">
								                                      ...
								                                      <s:iterator begin="pageBean.beginPageIndex" end="pageBean.endPageIndex" var="pageNums">
								                                        <li>
																			...
																			<c:if test="${pageBean.currentPage != pageNums }">
																				<a href="adminperson?pageNum=${pageNums }" >${pageNums }</a>
																			</c:if>
																		</li>
																		</s:iterator>
																		<li>
								                                          <a href="adminperson?pageNum=${pageBean.pageCount }" aria-label="Next">
